...
const char Keyboard::keymap_es_LA[0x80][2] =
{
    /* Orden: {Normal, Shift} */
...
{    
    ...
    if (pending) {
        ...
        /* Don't do anything on release. */
                ...
                (keymap_es_LA[keycode & 0x7F][shiftState]))
        {
            /* Write to buffer. */
            buffer[0] = keymap_es_LA[keycode & 0x7F][shiftState];
            return 1;
        }
    }
    return EAGAIN;
