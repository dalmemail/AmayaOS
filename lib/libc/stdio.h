...
#define stdin   fopen("/dev/stdin", "rw")
#define stdout  fopen("/dev/stdout", "rw")
...
/**
 * Copies characters from stdin into str until newline encountered, end-of-file reached, or error occurs.
 * Does not copy newline. The gets() function should not be used.
 * @param str String buffer to write the stdin. If no error, str is NUL-terminated.
 * @return Returns NULL on end-of-file or error, str otherwise.
 */
extern C char *gets(char *str);

/**
 * Copies n-1 characters from stdin into str until newline encountered, end-of-file reached, or error occurs.
 * Does not copy newline.
 * @param str String buffer to write the stdin. If no error, str is NUL-terminated.
 * @param size 
 * @return Returns NULL on end-of-file or error, str otherwise.
 */
extern C char *gets_s(char *str, size_t size);

/**
 * Writes a string buffer to stdout.
 * @param str Buffer to be written
 * @return Returns a non-negative number in success, EOF on error.
 */
extern C int puts(const char *str);

/**
 * Reads the next character from stdin.
 * @return Returns a null byte on error, a character byte otherwise.
 */
