...
static int read_file(int argc, char* fileName)
{
    ...
    int n_bytes = read(file, cnt, fnsize);
...
static void usage(void)
{
    printf("Modo de empleo: cat [OPCION]... [FICHERO]...\n\n"
           "  -b, --number-nonblank    No enumera las l%cneas en blanco, remplaza -n.\n"
           "  -e                       Lo mismo que -E.\n"
           "  -E, --show-ends          Muestra un $ al final de cada l%cnea.\n"
           "  -n, --number             Enumera cada l%cnea.\n"
           "  -t                       Lo mismo que -T.\n"
           "  -T, --show-tabs          Muestra los caracteres de tabulaci%cn como ^I\n"
           "      --help               Muestra esta ayuda y finaliza.\n"
           "      --version            Informa de la versi%cn y finaliza.\n\n"

           "AmayaOS Coreutils %s (C) 2017 AmayaOS Team\n"
           "Licencia GNU GPL v3 <http://www.gnu.org/licenses/>.\n"
           "Reportar errores a trav%cs de amaya@amayaos.com\n", 161, 161, 161, 162, 162, VERSION, 130);
}

static void version(void)
{
    printf("cat (AmayaOS Coreutils) v%s\n"
           "Copyright (C) 2017 AmayaOS Team.\n"
           "Licencia GPLv3+: GPL de GNU versi%cn 3 o posterior\n"
